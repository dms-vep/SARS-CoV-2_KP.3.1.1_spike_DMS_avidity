...
See [here](https://github.com/dms-vep/SARS-CoV-2_KP.3.1.1_spike_DMS/blob/main/results/RBD_up_down/RBD_up_down_sites.csv) for a CSV with these estimated effects for each site; the *RxRMS_be* gives the final effect estimate for each site calculated as above.
